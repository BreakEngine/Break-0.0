...
bool DX::Initialize(int Width, int Height, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	HRESULT result;
...
void DX::Begin(float red, float green, float blue, float alpha)
{
	float color[4];
...
void DX::GetVideoCardInfo(char* cardName, int& memory)
{
