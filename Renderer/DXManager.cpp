...
bool DXManager::init(ApplicationPtr app){
	...
	this->InitD3D(hWnd,app->_display->getWidth(),app->_display->getHeight(),true,false);
...
void DXManager::RenderFrame()
{
	// clear the back buffer to a deep blue
	float clearColor[4] = { 0.0f, 0.2f, 0.4f, 1.0f };
	Begin(clearColor);

	// do 3D rendering on the back buffer here  //////<<------------Rendring Function Call..

	End();
}

int DXManager::CleanD3D()
{
...
//Event Handller for this Window..
/////////////////////////////////////
...
void DXManager::Begin(float color[])
{
